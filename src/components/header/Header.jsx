...
const Header = () => {
  ...
  // const [isLoggedIn, setIsLoggedIn] = useState(Cookies.get("token")); // State for menu visibility
  const { setIsLoggedIn, isLoggedIn, isLoading, setIsLoading } = useAppContext();
  const handleLogout = () => {
