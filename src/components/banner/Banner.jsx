...
const Banner = () => (
  <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row gap-4 py-3 md:h-[80vh] px-3 relative">
    {/* all svgs */}
    <figure class="absolute top-10 start-0 ms-5">
    ...
    <div className="text-center md:text-left flex flex-col justify-center flex-1 relative">
      <figure class="fill-success absolute top-1/3 right-10 translate-middle-x mt-5 ms-5">
      ...
      <figure class="fill-warning absolute bottom-0 end-0 me-5 d-none d-xl-block">
      ...
      <h1 className="text-6xl font-bold text-gray-800 mb-2 leading-1">
        Limitless learning at your{" "}
        <span className="relative">
          fingertips{" "}
          <span className="absolute top-4 -right-5 translate-middle ms-3 -z-10">
            <svg
              width="300px"
              height="62.1px"
      ...
      <div className="flex items-center space-x-3">
        <div className="flex items-center gap-2">
          <MdVerified className="font-semibold" />
          <div className="text-gray-600 font-semibold">Learn with experts</div>
        </div>
        <div className="flex items-center gap-2">
          <MdVerified className="font-semibold" />
          <div className="text-gray-600 font-semibold">Get Certificate</div>
        </div>
        <div className="flex items-center gap-2">
          <MdVerified className="font-semibold" />
          <div className="text-gray-600 font-semibold">Get Membership</div>
        </div>
      </div>
      <div>
        <button className="mt-5 px-6 py-3 rounded text-lg font-semibold bg-red-200 text-red-800 hover:bg-red-300 hover:text-red-900 transition duration-200">
          Get Started
        </button>
      </div>
    </div>
    <div className="mt-4 md:mt-0 flex relative justify-center flex-1">
 
      <div className="react absolute left-3 bg-white shadow rounded-lg p-2 top-1/3">
        <img src="/react-logo.svg" alt="react-logo" />
      </div>
      <div className="react absolute right-3 bg-white shadow rounded-lg p-2 top-0">
        <img src="/angular.svg" alt="angular-logo" />
      </div>
      <img src="/hero2.jpg" alt="Banner" className="w-full  object-contain" />
    </div>
  </div>
);
