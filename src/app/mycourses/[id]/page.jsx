  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto p-4">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        <Link
          href="/mycourses"
          className="flex items-center text-blue-600 bg-white border border-blue-600 rounded-md py-2 px-4 shadow-lg transition-all hover:bg-blue-600 hover:text-white mb-4 md:mb-0"
        >
      ...
      <div className="flex flex-col md:flex-row bg-white border rounded-lg shadow-lg p-4 md:p-8 gap-4 md:gap-8 mb-6">
        {courseLoader ? (
          <CourseSkeleton />
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            <div className="col-span-1 md:col-span-4">
              <img src={courseData?.data?.photo} alt="course photo" className="w-full h-auto rounded-lg" />
            </div>
